...
;;     ryang-groovy
   ...
   dotspacemacs-additional-packages '(browse-kill-ring elfeed add-node-modules-path restclient company-restclient groovy-mode markdown-preview-mode exec-path-from-shell)
